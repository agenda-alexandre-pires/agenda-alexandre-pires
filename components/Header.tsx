      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        {isMobileMenuOpen && (
          <div className="fixed inset-0 bg-black flex flex-col items-center justify-center gap-8 md:hidden">
            ...
            <a onClick={() => setIsMobileMenuOpen(false)} href="/blog" className="text-2xl font-display text-white uppercase tracking-widest flex items-center gap-2">Blog <ExternalLink className="w-5 h-5" /></a>
